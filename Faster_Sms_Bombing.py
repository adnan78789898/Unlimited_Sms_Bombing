...
clear='clear';tool='Unlimited_SMS_Bomber';gift='Join_Telegram ';on=9;lim=0
coder='Adnan_Ahmed';team='';git='Adnan_Ahmed';tg='https://t.me/coinegg_miner_bot/miniapp?startapp=kBNoWEHfEAB7SWbQfgf '
credit={"Tool": tool, "Tools_Admin": coder, "Join_Telegram": team, "Facebook": git, "Script_Lagle": gift};go='xdg-open '
...
def DARK_TEAM_LMNx9():
    ...
    lmnx9_banner()
    lmnx9("[blue][[red]>[blue]][bold red] King_On_Adnan [bold yellow]Unlimited "+running)
    lmnx9(47*f'[bold cyan]-'+'[bold white]')
